<div class="content-wrapper col-md-10 float-right" style="min-height: 348px;">  
                                        ...
                                        <li>
                                            ...
                                            <div class="timeline-item">
                                                ...
                                                <div class="timeline-footer">
                                                    ...
                                                    <a href="<?php echo base_url(); ?>admin/enquiry/follow_up_delete/<?php echo $id; ?>/<?php echo $value['id']; ?>" class="btn btn-danger btn-xs" data-toggle="tooltip" title="" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');" data-original-title="Delete">Delete</a>
                                                </div>
                                            </div>
                                        </li>
                                        <?php
