...
<div class="content-wrapper col-md-10 float-right">
                   ...
                   <form role="form" action="<?php echo site_url('report/getsearchtypeparam') ?>" method="post" class="" id="reportform" >
                    ...
                    <div class="">
                        ...
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"><i class="fa fa-money"></i> <?php echo $this->lang->line('stock_report'); ?></h3>
                        </div>
                        <div class="box-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover inventory-list" data-export-title="<?php echo $this->lang->line('stock_report'); ?>">
                                    <thead>
                                        <tr>
